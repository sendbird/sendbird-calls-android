...
[![Maven](https://img.shields.io/badge/maven-v1.9.2-green.svg)](https://github.com/sendbird/sendbird-calls-android/tree/master/com/sendbird/sdk/sendbird-calls/1.9.2)
...
```groovy
dependencies {
    implementation 'com.sendbird.sdk:sendbird-calls:1.9.2'
}
```
