...
[![Maven](https://img.shields.io/badge/maven-v0.8.0-green.svg)](https://github.com/sendbird/sendbird-calls-android/tree/master/com/sendbird/sdk/sendbird-calls/0.8.0)
...
```groovy
dependencies {
    implementation 'com.sendbird.sdk:sendbird-calls:0.8.0'
}
```
