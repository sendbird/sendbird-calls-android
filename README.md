...
[![Maven](https://img.shields.io/badge/maven-v1.0.1-green.svg)](https://github.com/sendbird/sendbird-calls-android/tree/master/com/sendbird/sdk/sendbird-calls/1.0.1)
...
```groovy
dependencies {
    implementation 'com.sendbird.sdk:sendbird-calls:1.0.1'
}
```
